        ...
        >
          <div class="p-6 space-y-4 md:space-y-6 sm:p-8">
            ...
            <form @submit.prevent="register()" class="space-y-4 md:space-y-6" action="#">
              ...
              <button
                class="w-full border border-primary hover:bg-primary-700 focus:ring-4 focus:outline-none focus:ring-primary-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center dark:bg-primary-600 dark:hover:bg-primary-700 dark:focus:ring-primary-800"
              >
    ...
    .catch((err) => {
      ...
      switch (err.code) {
        ...
        case 'auth/user-not-fount':
          errorMessage.value = 'No account with that email was group'
          break
        case 'auth/wrong-password':
          errorMessage.value = 'Incorrect error'
          break
        default:
